...
- [x] 3.1 Build passes: `cd frontend && npm run build` — 836bbd1
- [x] 3.2 Lint passes: `cd frontend && npm run lint` — 836bbd1
- [x] 3.3 Unit tests pass: `cd frontend && npm run test` — 836bbd1
