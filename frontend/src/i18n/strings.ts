...
export const STRINGS = {
  ...
  "manager.finance.navLink": { pl: "Faktury", en: "Invoices" },
  "manager.finance.title": { pl: "Faktury vs dostawy", en: "Invoices vs deliveries" },
  "manager.finance.back": { pl: "Powrót do menedżera", en: "Back to manager" },
  "manager.finance.locationLabel": { pl: "Lokalizacja", en: "Location" },
  "manager.finance.daysLabel": { pl: "Okres", en: "Period" },
  "manager.finance.daysOptionLabel": { pl: "{n} dni", en: "{n} days" },
  "manager.finance.syncButton": { pl: "Odśwież z eBiuro", en: "Refresh from eBiuro" },
  "manager.finance.syncing": { pl: "Synchronizacja…", en: "Syncing…" },
  "manager.finance.syncResult": {
    pl: "eBiuro: firm {companies}, pobrano {fetched}, bez zmian {unchanged}, pominięto {skipped}, zapisano {upserted}",
    en: "eBiuro: companies {companies}, fetched {fetched}, unchanged {unchanged}, skipped {skipped}, upserted {upserted}",
  },
  "manager.finance.syncError": { pl: "Synchronizacja nieudana: {detail}", en: "Sync failed: {detail}" },
  "manager.finance.syncNotConfigured": {
    pl: "Synchronizacja z eBiuro nie jest skonfigurowana na serwerze.",
    en: "eBiuro sync is not configured on the server.",
  },
  "manager.finance.syncedAt": { pl: "Dane z eBiuro: {when}", en: "Data from eBiuro: {when}" },
  "manager.finance.syncedNever": { pl: "Brak synchronizacji z eBiuro", en: "Never synced with eBiuro" },
  "manager.finance.loading": { pl: "Ładowanie…", en: "Loading…" },
  "manager.finance.fetchError": { pl: "Błąd pobierania: {detail}", en: "Fetch error: {detail}" },
  "manager.finance.empty": {
    pl: "Brak dostaw w wybranym okresie.",
    en: "No deliveries in the selected period.",
  },
  "manager.finance.receiptsHeading": { pl: "Dostawy", en: "Deliveries" },
  "manager.finance.unmatchedHeading": { pl: "Faktury bez dostawy", en: "Invoices without a delivery" },
  "manager.finance.unmatchedEmpty": {
    pl: "Brak faktur bez przypisanej dostawy.",
    en: "No invoices without a matched delivery.",
  },
  "manager.finance.correctionsHeading": { pl: "Korekty", en: "Corrections" },
  "manager.finance.card.lineCount": { pl: "{n} pozycji", en: "{n} lines" },
  "manager.finance.card.photoCount": { pl: "{n} zdjęć WZ", en: "{n} WZ photos" },
  "manager.finance.card.estimate": { pl: "≈ {amount} zł netto", en: "≈ {amount} PLN net" },
  "manager.finance.card.noEstimate": { pl: "brak wyceny", en: "no estimate" },
  "manager.finance.card.duplicateBadge": { pl: "2× przyjęcie", en: "2× receipt" },
  "manager.finance.card.receivedBy": { pl: "Odebrał: {who}", en: "Received by: {who}" },
  "manager.finance.doc.invoiceNumber": { pl: "Nr faktury: {number}", en: "Invoice no.: {number}" },
  "manager.finance.doc.netto": { pl: "{amount} zł netto", en: "{amount} PLN net" },
  "manager.finance.doc.correctionBadge": { pl: "Korekta", en: "Correction" },
  "manager.finance.detail.selectPrompt": {
    pl: "Wybierz dostawę z listy po lewej.",
    en: "Select a delivery from the list on the left.",
  },
  "manager.finance.detail.loading": { pl: "Ładowanie szczegółów…", en: "Loading details…" },
  "manager.finance.detail.fetchError": {
    pl: "Błąd pobierania szczegółów: {detail}",
    en: "Error loading details: {detail}",
  },
  "manager.finance.detail.deliveryTitle": { pl: "Dostawa", en: "Delivery" },
  "manager.finance.detail.invoiceTitle": { pl: "Faktura", en: "Invoice" },
  "manager.finance.detail.noInvoice": { pl: "Brak dopasowanej faktury.", en: "No matched invoice." },
  "manager.finance.detail.receivedByLabel": { pl: "Kto odebrał", en: "Received by" },
  "manager.finance.detail.orderIdLabel": { pl: "Nr zamówienia", en: "Order no." },
  "manager.finance.detail.lineCountLabel": { pl: "Liczba pozycji", en: "Line count" },
  "manager.finance.detail.estimateLabel": { pl: "Szacunek", en: "Estimate" },
  "manager.finance.detail.photosLabel": { pl: "Zdjęcia WZ", en: "WZ photos" },
  "manager.finance.detail.noPhotos": { pl: "Brak zdjęć.", en: "No photos." },
  "manager.finance.detail.invoiceNumberLabel": { pl: "Nr faktury", en: "Invoice no." },
  "manager.finance.detail.ksefLabel": { pl: "Nr KSeF", en: "KSeF no." },
  "manager.finance.detail.issueDateLabel": { pl: "Data wystawienia", en: "Issue date" },
  "manager.finance.detail.sellDateLabel": { pl: "Data sprzedaży", en: "Sell date" },
  "manager.finance.detail.nettoLabel": { pl: "Netto", en: "Net" },
  "manager.finance.detail.bruttoLabel": { pl: "Brutto", en: "Gross" },
  "manager.finance.detail.contractorLabel": { pl: "Kontrahent", en: "Contractor" },
  "manager.finance.detail.openPdf": { pl: "Otwórz PDF", en: "Open PDF" },
  "manager.finance.detail.pdfError": {
    pl: "Nie udało się otworzyć PDF: {detail}",
    en: "Could not open the PDF: {detail}",
  },
  "manager.finance.detail.candidatesLabel": { pl: "Inne dopasowania", en: "Other candidates" },
  "manager.finance.detail.candidatePill": {
    pl: "{number} · {date} · {netto} zł",
    en: "{number} · {date} · {netto}",
  },
  "manager.finance.table.product": { pl: "Produkt", en: "Product" },
  "manager.finance.table.received": { pl: "Odebrano", en: "Received" },
  "manager.finance.table.invoice": { pl: "Na fakturze", en: "On invoice" },
  "manager.finance.table.delta": { pl: "Δ", en: "Δ" },
  "manager.finance.table.status": { pl: "Status", en: "Status" },
  "manager.finance.table.empty": { pl: "Brak pozycji do porównania.", en: "No lines to compare." },
  "manager.finance.line.ok": { pl: "Zgodne", en: "Match" },
  "manager.finance.line.ok_converted": { pl: "Przeliczone", en: "Converted" },
  "manager.finance.line.qty_diff": { pl: "Różnica ilości", en: "Qty difference" },
  "manager.finance.line.not_on_invoice": { pl: "Brak na fakturze", en: "Not on invoice" },
  "manager.finance.extra.heading": { pl: "Na fakturze, nie odebrano", en: "On invoice, not received" },
  "manager.finance.extra.assignPlaceholder": { pl: "Przypisz do produktu…", en: "Assign to product…" },
  "manager.finance.extra.assignButton": { pl: "Przypisz", en: "Assign" },
  "manager.finance.extra.assigned": { pl: "Przypisano produkt.", en: "Product assigned." },
  "manager.finance.extra.assignError": { pl: "Błąd przypisania: {detail}", en: "Assign error: {detail}" },
  "manager.finance.review.notePlaceholder": { pl: "Notatka (opcjonalnie)…", en: "Note (optional)…" },
  "manager.finance.review.confirmButton": { pl: "Zgodne ✓", en: "Confirmed ✓" },
  "manager.finance.review.mismatchButton": { pl: "Niezgodność ✗", en: "Mismatch ✗" },
  "manager.finance.review.saving": { pl: "Zapisywanie…", en: "Saving…" },
  "manager.finance.review.saveError": { pl: "Błąd zapisu: {detail}", en: "Save error: {detail}" },
  "manager.finance.review.existing": {
    pl: "Ocena: {status} · {actor} · {when}",
    en: "Review: {status} · {actor} · {when}",
  },
  "manager.finance.review.noteLabel": { pl: "Notatka: {note}", en: "Note: {note}" },
  "manager.finance.review.statusConfirmed": { pl: "Zgodne", en: "Confirmed" },
  "manager.finance.review.statusMismatch": { pl: "Niezgodność", en: "Mismatch" },
  "manager.finance.review.needDocument": {
    pl: "Wybierz najpierw fakturę.",
    en: "Select an invoice first.",
  },
  "manager.finance.toast.reviewSaved": { pl: "Ocena zapisana.", en: "Review saved." },
